    ...
    public int CheckForWall(int direction)
    {
        ...
        do
        {
            switch (direction)
            {
                ...
                case 1:
                    if (TheCube.theCube[coordinates.X, coordinates.Y - 1, coordinates.Z] == 1)
                    {
                ...
                case 3:
                    if (TheCube.theCube[coordinates.X, coordinates.Y, coordinates.Z - 1] == 1)
                    {
                        Console.WriteLine("There is a wall on that direction, choose another one");
                        isWall = true;
                        direction = ChooseDirection();
                ...
                case 5:
                    if (TheCube.theCube[coordinates.X - 1, coordinates.Y, coordinates.Z] == 1)
                    {
                        Console.WriteLine("There is a wall on that direction, choose another one");
                        isWall = true;
                        direction = ChooseDirection();
